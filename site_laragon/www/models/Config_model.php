    ...
    public function add()
    {
        if (isset($_POST["offSubmit"])) {
            ...
            if (!empty($_POST["off_cat"]) && !empty($_POST["off_prix"]) && !empty($_POST["off_descrip"])) {
                ...
                $RequestStatement->bindValue(':off_prix', $off_prix, PDO::PARAM_STR);
    ...
    public function modify()
    {
        ...
        { 
            if(!empty($_POST["off_cat"]) && !empty($_POST["off_prix"]) && !empty($_POST["off_descrip"]))
            {
                ...
                $requete->bindValue(':off_prix', $off_prix, PDO::PARAM_STR);
            ...
            if($requete){
                ...
                echo "de la catégorie".$off_cat." a bien été modifié. ";
                }else{
...
public function countAchatCategories()
{
    ...
    $query->execute();
    return $query->fetchAll(PDO::FETCH_ASSOC); // Fetch associative array with category and count
}
}
?>    